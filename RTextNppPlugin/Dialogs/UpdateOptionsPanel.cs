...
namespace NppPluginNET.Dialogs
{
    public partial class UpdateOptionsPanel : Form
    {
        ...
        {
            string srcDir = Path.Combine(pluginDir, "NppPluginNET");
            string deploymentDir = Path.Combine(tempDir, "NppPluginNET.Updater");
        ...
        {
            Process.Start("http://csscript.net/npp/NppPluginNET." + version + ".ReleaseNotes.html");
        }
